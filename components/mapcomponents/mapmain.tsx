    ...
    locations.forEach((loc, i) => {
      ...
      <a href="/salon/${loc.id}">
        <div style="font-family: sans-serif; color: black; width: 240px; padding-top: 4px;">
          ...
          <svg 
            style="width:20px; height:20px; fill:#FFD700;" 
            aria-hidden="true" 
          ...
          <p style="margin-left:6px; font-size:13px; font-weight:bold; color:#333;">
            4.95
          </p>
        
          <span style="width:4px; height:4px; margin:0 6px; background:#999; border-radius:50%;"></span>
        
          <a href="#" style="font-size:13px; color:#333; text-decoration:underline;">
            73 reviews
          </a>
        </div>
